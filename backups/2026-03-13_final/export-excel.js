  ...
  grupos.forEach(g => {
    ...
    combinada.forEach(rb => {
      ...
      if(isGrp){
        ...
        let pSI=0,pAdi=0,pRed=0,pCre=0,pCco=0,pPD=0,pMes=new Array(nMes).fill(0),pGas=0,pComp=0,pSaldo=0;
        hijos.forEach(x => {
        ...
        const vals = [pSI,pAdi,pRed,pCre,pCco,pPD,...pMes,pGas,pComp,pGas,pSaldo,pGas,0,0];
