...
<div class="ao-section">
  ...
  <table class="ao-tabla">
    ...
    <tr>
      ...
      <td colspan="3">
        {{ dias_duracion }} días hábiles, contados desde la suscripción del acta de inicio.
      </td>
    </tr>
    <tr>
...
<div class="ai-section">
  ...
  <table class="ai-tabla">
    ...
    <tr>
      ...
      <td><strong>{{ dias_duracion }} días hábiles</strong></td>
    </tr>
  </table>
</div>
...
<div class="al-section">
  ...
  <table class="al-tabla">
    ...
    <tr>
      <th>Duración pactada</th>
      <td>{{ dias_duracion }} días hábiles</td>
      <th>Supervisor</th>
      <td>{{ supervisor }}</td>
    </tr>
    <tr>
...
<div class="ct-clausula">
  ...
  <p>
    ...
    <strong>{{ dias_duracion }} días hábiles</strong>, contados a partir de
      ...
      <td>
        <div class="ct-firma-linea">
          {% if sexo_contratista == 'E' and rep_legal_nombre %}
            ...
            <p class="ct-firma-cargo">CC N.° {{ format_id(rep_legal_cc) }}</p>
            <p class="ct-firma-cargo">Representante Legal</p>
            <p class="ct-firma-cargo">{{ nombre_contratista }}</p>
...
<p class="inv-parrafo">
  El plazo de ejecución será de <strong>{{ dias_duracion }} días hábiles</strong>,
...
<div class="inv2-section">
  ...
  <p>
    <strong>{{ dias_duracion }} días hábiles</strong>, contados a partir del acta de inicio.
  </p>
  <p>
...
<div class="invg-section">
  ...
  <p>
    ...
    la constitución y aprobación de la póliza de garantía.
  </p>
  <p>
    <strong>Inicio estimado:</strong> {{ fecha_inicio_larga }}&nbsp;&nbsp;&nbsp;
    <strong>Terminación estimada:</strong> {{ fecha_fin_larga }}
...
<div class="invg-section">
  ...
  <p>
    ...
    y manifestación expresa de capacidad para constituir la póliza de garantía.
  </p>
</div>
...
<div class="oc-section">
  ...
  <p>
    <strong>Plazo de ejecución:</strong> {{ dias_duracion }} días hábiles. &nbsp;
...
<div class="rp-section">
  ...
  <table class="rp-info">
    ...
    <tr>
      <th>Duración</th>
      <td colspan="3">{{ dias_duracion }} días hábiles</td>
    </tr>
  </table>
</div>
