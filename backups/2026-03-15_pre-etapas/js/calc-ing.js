...
function getRecaudoEfectivoIng(d, cod, trim){
  ...
  // El recaudo = presupuesto definitivo (NO más, NO menos).
  // Las reducciones son movimientos internos — reducen tanto el presupuesto como el recaudo,
  // ya que ese dinero se reasignó a otro rubro. El saldo por recaudar siempre queda en 0.
  ...
  if(rubro && rubro.en_banco){
    ...
    // El recaudo iguala al definitivo para que el saldo por recaudar sea siempre 0.
