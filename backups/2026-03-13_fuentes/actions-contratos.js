...
function _guardarPagoEditado(){
  ...
  const todosPagados = _pagosTemp.length > 0 && _pagosTemp.every(pp => pp.fecha_pago && pp.num_egreso);
...
function guardarContrato(){
  ...
  // Auto-liquidar si todos los pagos tienen fecha Y egreso generado
  if(_pagosTemp.length > 0 && _pagosTemp.every(pp => pp.fecha_pago && pp.num_egreso) && estadoFinal === 'En ejecucion'){
