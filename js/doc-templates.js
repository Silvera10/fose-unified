...
<table class="inv-tabla">
  <thead>
    <tr class="inv-hdr-verde">
      ...
      <th style="width:22%">Vigencia</th>
      <th style="width:18%">Responsable</th>
    </tr>
  </thead>
  <tbody>
    <tr><td colspan="5" style="background:#e8f5e9;font-weight:bold;text-align:center;padding:6px;font-size:9pt;text-transform:uppercase;letter-spacing:0.5px">Documentos que aporta el oferente con su propuesta</td></tr>
    <tr>
      <td class="inv-num">1</td>
      <td>Fotocopia documento de identidad</td>
      <td>Documento de identidad del interesado o representante legal. Copia legible, fotografía y número visibles.</td>
      <td>N/A</td>
      <td>Oferente</td>
    </tr>
    <tr class="inv-fila-alt">
      ...
      <td>Detalla actividades económicas y responsabilidades tributarias. Debe estar actualizado con datos vigentes.</td>
      <td>Generación no superior a 1 año</td>
      <td>Oferente</td>
    </tr>
    <tr>
      ...
      <td>Planilla del mes inmediatamente anterior</td>
      <td>Oferente</td>
    </tr>
    <tr class="inv-fila-alt">
      <td class="inv-num">4</td>
      <td>Formato único hoja de vida</td>
      <td>Formato SIGEP para contratos de prestación de servicios.</td>
      <td>Actualizada (si aplica)</td>
      <td>Oferente</td>
    </tr>
    <tr>
      <td class="inv-num">5</td>
      <td>Autorización tratamiento de datos</td>
      <td>Autoriza tratamiento y publicidad de datos del proponente.</td>
    ...
    <tr class="inv-fila-alt">
      ...
      <td>Expedido por Cámara de Comercio. Legible, con código de verificación visible.</td>
      <td>No superior a 30 días. Renovada al momento de contratar</td>
      <td>Oferente (si aplica)</td>
    </tr>
    <tr>
      <td class="inv-num">7</td>
      <td>REDAM - Deudores alimentarios morosos</td>
      <td>Constancia de NO tener anotación en el Registro de Deudores Alimentarios Morosos (Ley 2097/2021).</td>
      <td>Vigente al momento de presentación</td>
      <td>Oferente (requiere clave)</td>
    </tr>
    <tr class="inv-fila-alt">
      <td class="inv-num">8</td>
      <td>Certificación bancaria</td>
      <td>Certifica cuenta a nombre del contratista (tipo y número de cuenta).</td>
      <td>No superior a 30 días</td>
      <td>Oferente</td>
    </tr>
    <tr>
      <td class="inv-num">9</td>
      <td>Oferta o propuesta económica</td>
      <td>Presentada en términos de la invitación. Firmada, sin tachones ni enmendaduras.</td>
      <td>Según cronograma del proceso</td>
      <td>Oferente</td>
    </tr>
    <tr><td colspan="5" style="background:#e3f2fd;font-weight:bold;text-align:center;padding:6px;font-size:9pt;text-transform:uppercase;letter-spacing:0.5px">Verificación en línea por la Institución Educativa (Decreto 019 de 2012)</td></tr>
    <tr class="inv-fila-alt">
      <td class="inv-num">10</td>
      <td>Antecedentes disciplinarios — Procuraduría</td>
      <td>Consulta en línea — Procuraduría General de la Nación.</td>
      <td>Verificación al momento de evaluar</td>
      <td>Entidad</td>
    </tr>
    <tr>
      <td class="inv-num">11</td>
      <td>Antecedentes fiscales — Contraloría</td>
      <td>Consulta en línea — Contraloría General de la República.</td>
      <td>Verificación al momento de evaluar</td>
      <td>Entidad</td>
    </tr>
    <tr class="inv-fila-alt">
      <td class="inv-num">12</td>
      <td>Antecedentes judiciales — Policía Nacional</td>
      <td>Consulta en línea — Policía Nacional.</td>
      <td>Verificación al momento de evaluar</td>
      <td>Entidad</td>
    </tr>
    <tr>
      <td class="inv-num">13</td>
      <td>Medidas correctivas — RNMC</td>
      <td>Consulta en línea — Registro Nacional Código de Policía.</td>
      <td>Verificación al momento de evaluar</td>
      <td>Entidad</td>
    </tr>
    <tr class="inv-fila-alt">
      <td class="inv-num">14</td>
      <td>Inhabilidades por delitos sexuales contra menores</td>
      <td>Consulta en línea — Policía Nacional (Ley 1918/2018). Obligatorio en Instituciones Educativas.</td>
      <td>Verificación al momento de evaluar</td>
      <td>Entidad</td>
    </tr>
  </tbody>
</table>
<p style="font-size:8.5pt;text-align:justify;margin:6px 0;line-height:1.4;color:#555"><strong>Nota:</strong> Los documentos aportados deben ser legibles en su totalidad. Los documentos ilegibles, borrosos o incompletos serán requeridos para subsanación. Los documentos escaneados deben presentarse en formato PDF con resolución que garantice su lectura. De conformidad con el Decreto 019 de 2012 (Ley Antitrámites), la Institución verificará directamente los documentos de consulta pública en línea al momento de la evaluación de las ofertas.</p>
...
<div class="inv2-section">
  ...
  <table class="inv2-table">
    <thead>
      <tr>
        <th style="width:4%">#</th>
        <th class="left" style="width:22%">Documento</th>
        <th class="left" style="width:34%">Descripción</th>
        <th class="left" style="width:22%">Vigencia</th>
        <th class="left" style="width:18%">Responsable</th>
      </tr>
    </thead>
    <tbody>
      <tr><td colspan="5" style="background:#e8f5e9;font-weight:bold;text-align:center;padding:6px;font-size:9pt;text-transform:uppercase;letter-spacing:0.5px">Documentos que aporta el oferente con su propuesta</td></tr>
      <tr><td style="text-align:center">1</td><td>Fotocopia documento de identidad</td><td>Documento de identidad del interesado o representante legal. Copia legible, fotografía y número visibles.</td><td>N/A</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">2</td><td>RUT - Registro Único Tributario</td><td>Detalla actividades económicas y responsabilidades tributarias. Debe estar actualizado con datos vigentes.</td><td>Generación no superior a 1 año</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">3</td><td>Seguridad social</td><td>Constancia de afiliación o planilla de pago al SGSS.</td><td>Planilla del mes inmediatamente anterior</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">4</td><td>Formato único hoja de vida</td><td>Formato SIGEP para contratos de prestación de servicios.</td><td>Actualizada (si aplica)</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">5</td><td>Autorización tratamiento de datos</td><td>Autoriza tratamiento y publicidad de datos del proponente.</td><td>Al momento de presentar propuesta</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">6</td><td>Existencia y representación legal</td><td>Expedido por Cámara de Comercio. Legible, con código de verificación visible.</td><td>No superior a 30 días. Renovada al momento de contratar</td><td>Oferente (si aplica)</td></tr>
      <tr><td style="text-align:center">7</td><td>REDAM - Deudores alimentarios morosos</td><td>Constancia de NO tener anotación en el Registro de Deudores Alimentarios Morosos (Ley 2097/2021).</td><td>Vigente al momento de presentación</td><td>Oferente (requiere clave)</td></tr>
      <tr><td style="text-align:center">8</td><td>Certificación bancaria</td><td>Certifica cuenta a nombre del contratista (tipo y número de cuenta).</td><td>No superior a 30 días</td><td>Oferente</td></tr>
      <tr><td style="text-align:center">9</td><td>Oferta o propuesta económica</td><td>Presentada en términos de la invitación. Firmada, sin tachones ni enmendaduras.</td><td>Según cronograma del proceso</td><td>Oferente</td></tr>
      <tr><td colspan="5" style="background:#e3f2fd;font-weight:bold;text-align:center;padding:6px;font-size:9pt;text-transform:uppercase;letter-spacing:0.5px">Verificación en línea por la Institución Educativa (Decreto 019 de 2012)</td></tr>
      <tr><td style="text-align:center">10</td><td>Antecedentes disciplinarios — Procuraduría</td><td>Consulta en línea — Procuraduría General de la Nación.</td><td>Verificación al momento de evaluar</td><td>Entidad</td></tr>
      <tr><td style="text-align:center">11</td><td>Antecedentes fiscales — Contraloría</td><td>Consulta en línea — Contraloría General de la República.</td><td>Verificación al momento de evaluar</td><td>Entidad</td></tr>
      <tr><td style="text-align:center">12</td><td>Antecedentes judiciales — Policía Nacional</td><td>Consulta en línea — Policía Nacional.</td><td>Verificación al momento de evaluar</td><td>Entidad</td></tr>
      <tr><td style="text-align:center">13</td><td>Medidas correctivas — RNMC</td><td>Consulta en línea — Registro Nacional Código de Policía.</td><td>Verificación al momento de evaluar</td><td>Entidad</td></tr>
      <tr><td style="text-align:center">14</td><td>Inhabilidades por delitos sexuales contra menores</td><td>Consulta en línea — Policía Nacional (Ley 1918/2018). Obligatorio en Instituciones Educativas.</td><td>Verificación al momento de evaluar</td><td>Entidad</td></tr>
    </tbody>
  </table>
  <p style="font-size:8.5pt;text-align:justify;margin:6px 0;line-height:1.4;color:#555"><strong>Nota:</strong> Los documentos aportados deben ser legibles en su totalidad. Los documentos ilegibles, borrosos o incompletos serán requeridos para subsanación. De conformidad con el Decreto 019 de 2012 (Ley Antitrámites), la Institución verificará directamente los documentos de consulta pública en línea al momento de la evaluación de las ofertas.</p>
</div>
